...
<nav class="navbar">
    <div class="navbar-inner">
        ...
        <div class="nav-right">
            ...
            <a href="../auth/admin_logout.php" class="btn-logout">Sign Out</a>
        </div>
    </div>
</nav>
...
<div class="main">
    ...
    <div class="layout">
        ...
        <!-- RIGHT: STAFF TABLE -->
        <div class="card motion-fade-up motion-delay-2">
...
<!-- RESET PASSWORD MODAL -->
    <div class="modal-overlay" id="resetModal">
        <div class="modal motion-pop">
            <h3>🔑 Reset Password</h3>
            <p id="resetModalLabel">Enter a new password for this staff member.</p>
            <form action="../admin/admin_dashboard.php" method="POST" data-motion-loading>
                ...
                <div class="modal-actions">
                    ...
                    <button type="submit" class="btn-confirm-reset" data-loading-text="Resetting…">Reset</button>
                </div>
            </form>
        </div>
    </div>
