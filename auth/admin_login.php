...
<div class="wrap">
    ...
    <div class="card">
        ...
        <form action="../auth/admin_login.php" method="POST" data-motion-loading>
            <div class="field">
            ...
            <button type="submit" class="btn" data-loading-text="Verifying…">Sign In</button>
        </form>
    </div>

    <div class="footer motion-fade-up motion-delay-2">
        Not an admin? <a href="../auth/staff_login.php" class="motion-underline">Staff Login</a> · <a href="../auth/login.php" class="motion-underline">Student Login</a>
    </div>
</div>
