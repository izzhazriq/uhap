...
$client_secret = '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';
$redirect_uri  = 'http://localhost/uhap/google_auth.php'; // ← change 'uhap' to your folder name
...
if ($token_response === false) {
    ...
    header("Location: login.php?google_error=$error");
    exit;
}
